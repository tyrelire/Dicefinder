...
class __TwigTemplate_a260513521b5c1242dbf3bbf79a64351 extends Template
{
    ...
    <div class=\"bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg shadow-lg w-full md:max-w-xl mx-auto\">
        <h2 class=\"text-2xl font-bold text-center mb-6\">Félicitations !</h2>
        <p class=\"text-center\">";
        // line 9
...
{% endblock %}
", "payment/success.html.twig", "C:\\Users\\benja\\Documents\\GitHub\\dicefinder\\templates\\payment\\success.html.twig");
    }
}
