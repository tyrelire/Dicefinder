...
class __TwigTemplate_9a9f9bb32bf59bda12a2c8b62c23df43 extends Template
{
    ...
    <div class=\"w-full max-w-md space-y-8\">
        <div>
            <h1 class=\"mt-6 text-center text-3xl font-bold tracking-tight text-white\">DiceFinder</h1>
        ...
        yield "\" autocomplete=\"email\" required autofocus class=\"relative block w-full appearance-none rounded-none rounded-t-md border border-gray-300 px-3 py-2 text-black placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm\" placeholder=\"toi@exemple.com\">
                </div>
                <div>
