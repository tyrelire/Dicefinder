...
class __TwigTemplate_9f9dcb9cc32f93538dfbd9e37fb38ea0 extends Template
{
...
$context["groupe_j_d_r"], "status", [], "any", false, false, false, 129) == "termine")) {
    ...
    <!-- Ajout du bloc Licence ou Catégories -->
    <div class=\"mt-4\">
        ";
            // line 167
            if (CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "licence", [], "any", false, false, false, 167)) {
                // line 168
                yield "            <div class=\"text-sm bg-gradient-to-r from-blue-500 to-blue-700 text-white py-1 px-3 rounded-lg shadow-lg\">
                Licence: <span class=\"font-semibold\">";
                // line 169
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "licence", [], "any", false, false, false, 169), "name", [], "any", false, false, false, 169), "html", null, true);
                yield "</span><br>
                <span class=\"text-xs text-gray-200\">Éditeur : ";
                // line 170
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "licence", [], "any", false, false, false, 170), "publisher", [], "any", false, false, false, 170), "html", null, true);
                yield " | Sortie : ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "licence", [], "any", false, false, false, 170), "releaseYear", [], "any", false, false, false, 170), "html", null, true);
                yield "</span>
            </div>
        ";
            } else {
                ...
                yield "                ";
                $context['_parent'] = $context;
                $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "categories", [], "any", false, false, false, 175));
                $context['loop'] = [
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
                    // line 176
                    yield "                    ";
                    $context["color"] = CoreExtension::getAttribute($this->env, $this->source, (isset($context["colors"]) || array_key_exists("colors", $context) ? $context["colors"] : (function () { throw new RuntimeError('Variable "colors" does not exist.', 176, $this->source); })()), (CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, false, 176) % Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["colors"]) || array_key_exists("colors", $context) ? $context["colors"] : (function () { throw new RuntimeError('Variable "colors" does not exist.', 176, $this->source); })()))), [], "array", false, false, false, 176);
                    // line 177
                    yield "                    <span class=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["color"]) || array_key_exists("color", $context) ? $context["color"] : (function () { throw new RuntimeError('Variable "color" does not exist.', 177, $this->source); })()), "html", null, true);
                    yield " text-xs font-medium px-2.5 py-0.5 rounded-full\">";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["category"], "name", [], "any", false, false, false, 177), "html", null, true);
                    yield "</span>
                ";
                    ++$context['loop']['index0'];
                    ++$context['loop']['index'];
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const selectedCategories = ";
        // line 232
        yield json_encode((isset($context["selectedCategories"]) || array_key_exists("selectedCategories", $context) ? $context["selectedCategories"] : (function () { throw new RuntimeError('Variable "selectedCategories" does not exist.', 232, $this->source); })()));
        yield ";
