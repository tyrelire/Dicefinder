...
<div class=\"container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8\">
    ...
    <div class=\"container mx-auto flex flex-col mt-12\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::reverse($this->env->getCharset(), (isset($context["nouveaux_groupes"]) || array_key_exists("nouveaux_groupes", $context) ? $context["nouveaux_groupes"] : (function () { throw new RuntimeError('Variable "nouveaux_groupes" does not exist.', 150, $this->source); })())));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["groupe"]) {
            ...
            yield "\" class=\"block bg-gray-500 rounded-lg backdrop-blur-2xl bg-opacity-30 border border-gray-100 shadow-md p-6 pb-5 text-white transition-transform duration-300 hover:scale-105 hover:shadow-2xl\">
                    <img src=\"";
            // line 152
    ...
    <div class=\"container mx-auto flex flex-col mt-12\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["groupe"]) {
            ...
            yield "\" class=\"block bg-gray-500 rounded-lg backdrop-blur-2xl bg-opacity-30 border border-gray-100 shadow-md p-6 pb-5 text-white transition-transform duration-300 hover:scale-105 hover:shadow-2xl\">
                    <img src=\"";
            // line 195
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/images-jdr/" . CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "picture", [], "any", false, false, false, 195))), "html", null, true);
            yield "\" 
                        alt=\"";
            // line 196
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "title", [], "any", false, false, false, 196), "html", null, true);
            yield " image\" 
                        class=\"rounded-lg mb-4 w-full h-[20rem] object-cover 
                        ";
            // line 198
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "players", [], "any", false, false, false, 198)) >= CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "maxPlayer", [], "any", false, false, false, 198))) {
                yield " blur ";
            }
            yield "\">
                    <div class=\"flex justify-between items-center\">
                        <p class=\"font-semibold hover:underline truncate max-w-[90%]\">";
            // line 200
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "title", [], "any", false, false, false, 200), "html", null, true);
            yield "</p>
                    </div>
                    <div class=\"flex justify-between items-center mt-4\">
                        <div class=\"flex items-center\">
                            ";
            // line 204
            if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "owner", [], "any", false, false, false, 204), "avatar", [], "any", false, false, false, 204)) {
                // line 205
                yield "                                <img src=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/avatars/" . CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "owner", [], "any", false, false, false, 205), "avatar", [], "any", false, false, false, 205))), "html", null, true);
                yield "\" alt=\"Avatar MJ\" class=\"w-8 h-8 rounded-full\">
                            ";
            } else {
                // line 207
            ...
            yield "                            <div class=\"ml-2\">
                                ...
                                <p class=\"text-xs text-white\">";
            // line 211
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "owner", [], "any", false, false, false, 211), "username", [], "any", false, false, false, 211), "html", null, true);
            yield "</p>
                            </div>
                        </div>
                        <div class=\"text-right\">
                            ...
                            ";
            // line 216
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "players", [], "any", false, false, false, 216)) >= CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "maxPlayer", [], "any", false, false, false, 216))) {
                // line 217
                yield "                                <p class=\"text-lg font-bold text-red-500\">Complet</p>
                            ";
            } else {
                // line 219
                yield "                                <p class=\"text-lg font-bold text-white\">";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "players", [], "any", false, false, false, 219)), "html", null, true);
                yield " / ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["groupe"], "maxPlayer", [], "any", false, false, false, 219), "html", null, true);
                yield "</p>
                            ";
            }
            // line 221
    ...
    <div class=\"container mx-auto flex flex-col mt-12 z-30 relative\">
        ...
        // line 237
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::slice($this->env->getCharset(), (isset($context["groupes"]) || array_key_exists("groupes", $context) ? $context["groupes"] : (function () { throw new RuntimeError('Variable "groupes" does not exist.', 237, $this->source); })()), 0, 8));
        $context['_iterated'] = false;
        foreach ($context['_seq'] as $context["_key"] => $context["groupe_j_d_r"]) {
            // line 238
            yield "                <a href=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_groupe_j_d_r_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "id", [], "any", false, false, false, 238)]), "html", null, true);
            yield "\" class=\"block bg-gray-500 rounded-lg backdrop-blur-2xl bg-opacity-30 border border-gray-100 shadow-md p-6 pb-5 text-white transition-transform duration-300 hover:scale-105 hover:shadow-2xl\">
                    <img src=\"";
            // line 239
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/images-jdr/" . CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "picture", [], "any", false, false, false, 239))), "html", null, true);
            yield "\" 
                        alt=\"";
            // line 240
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "title", [], "any", false, false, false, 240), "html", null, true);
            yield " image\" 
                        class=\"rounded-lg mb-4 w-full h-[20rem] object-cover 
                        ";
            // line 242
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "players", [], "any", false, false, false, 242)) >= CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "maxPlayer", [], "any", false, false, false, 242))) {
                yield " blur ";
            }
            yield "\">
            ...
            yield "</p>
                    ...
                    <div class=\"flex justify-between items-center mt-2\">
                        <div class=\"flex items-center\">
                            ";
            // line 248
            if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "owner", [], "any", false, false, false, 248), "avatar", [], "any", false, false, false, 248)) {
                // line 249
                yield "                                <img src=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/avatars/" . CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "owner", [], "any", false, false, false, 249), "avatar", [], "any", false, false, false, 249))), "html", null, true);
            ...
            yield "                            <div class=\"ml-2\">
                                ...
                                <p class=\"text-xs text-white\">";
            // line 255
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "owner", [], "any", false, false, false, 255), "username", [], "any", false, false, false, 255), "html", null, true);
            yield "</p>
                            </div>
                        </div>
                        <div class=\"text-right\">
                            ...
                            ";
            // line 260
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "players", [], "any", false, false, false, 260)) >= CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "maxPlayer", [], "any", false, false, false, 260))) {
                // line 261
                yield "                                <p class=\"text-lg font-bold text-red-500\">Complet</p>
                            ";
            } else {
                // line 263
                yield "                                <p class=\"text-lg font-bold text-white\">";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "players", [], "any", false, false, false, 263)), "html", null, true);
                yield " / ";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["groupe_j_d_r"], "maxPlayer", [], "any", false, false, false, 263), "html", null, true);
                yield "</p>
                            ";
            }
            // line 265
...
";
    ...
    {
        return array (  595 => 284,  582 => 274,  577 => 271,  570 => 269,  562 => 265,  554 => 263,  550 => 261,  548 => 260,  540 => 255,  536 => 253,  530 => 251,  524 => 249,  522 => 248,  515 => 244,  508 => 242,  503 => 240,  499 => 239,  494 => 238,  489 => 237,  482 => 233,  474 => 227,  467 => 225,  459 => 221,  451 => 219,  447 => 217,  445 => 216,  437 => 211,  433 => 209,  427 => 207,  421 => 205,  419 => 204,  412 => 200,  405 => 198,  400 => 196,  396 => 195,  391 => 194,  386 => 193,  379 => 189,  372 => 184,  365 => 182,  357 => 178,  349 => 176,  345 => 174,  343 => 173,  335 => 168,  331 => 166,  325 => 164,  319 => 162,  317 => 161,  310 => 157,  303 => 155,  298 => 153,  294 => 152,  289 => 151,  284 => 150,  278 => 147,  267 => 139,  258 => 133,  225 => 103,  216 => 97,  201 => 85,  192 => 79,  148 => 38,  138 => 31,  131 => 26,  123 => 22,  115 => 18,  113 => 17,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
    ...
    <div class=\"container mx-auto flex flex-col mt-12\">
        ...
        <div class=\"mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4\">
            {% for groupe in nouveaux_groupes|reverse %}
                <a href=\"{{ path('app_groupe_j_d_r_show', {'id': groupe.id}) }}\" class=\"block bg-gray-500 rounded-lg backdrop-blur-2xl bg-opacity-30 border border-gray-100 shadow-md p-6 pb-5 text-white transition-transform duration-300 hover:scale-105 hover:shadow-2xl\">
                    <img src=\"{{ asset('uploads/images-jdr/' ~ groupe.picture) }}\" 
                        alt=\"{{ groupe.title }} image\" 
                        class=\"rounded-lg mb-4 w-full h-[20rem] object-cover 
                        {% if groupe.players|length >= groupe.maxPlayer %} blur {% endif %}\">
                    <div class=\"flex justify-between items-center\">
    ...
    <div class=\"container mx-auto flex flex-col mt-12 z-30 relative\">
        ...
        <div class=\"mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4\">
            {% for groupe_j_d_r in groupes|slice(0, 8) %}
                <a href=\"{{ path('app_groupe_j_d_r_show', {'id': groupe_j_d_r.id}) }}\" class=\"block bg-gray-500 rounded-lg backdrop-blur-2xl bg-opacity-30 border border-gray-100 shadow-md p-6 pb-5 text-white transition-transform duration-300 hover:scale-105 hover:shadow-2xl\">
