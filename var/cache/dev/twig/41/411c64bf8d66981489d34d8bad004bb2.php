...
class __TwigTemplate_3169b132cea6cfdb19adff3e06951a1b extends Template
{
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // line 410
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["stripePublicKey"]) || array_key_exists("stripePublicKey", $context) ? $context["stripePublicKey"] : (function () { throw new RuntimeError('Variable "stripePublicKey" does not exist.', 410, $this->source); })()), "html", null, true);
        yield "';
        if (!stripePublicKey) {
