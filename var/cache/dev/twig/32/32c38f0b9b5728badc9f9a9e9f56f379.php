...
class __TwigTemplate_d4dcebbe6465ca8e934c3ecb6c783bff extends Template
{
    ...
    <div class=\"bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg shadow-lg w-full md:max-w-xl mx-auto\">
        <h2 class=\"text-2xl font-bold text-center mb-6\">Paiement annulé</h2>
        <p class=\"text-center\">";
        // line 9
...
{% endblock %}
", "payment/cancel.html.twig", "C:\\Users\\benja\\Documents\\GitHub\\dicefinder\\templates\\payment\\cancel.html.twig");
    }
}
