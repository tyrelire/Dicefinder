...
class __TwigTemplate_1f51dc016af8225e7cad19747ca6d1d3 extends Template
{
    ...
    <div class=\"mt-10 grid gap-4 lg:grid-cols-3 lg:grid-rows-2\">
        ...
        yield "
                            ...
                            <div class=\"mb-6\">
                                ";
        // line 30
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 30, $this->source); })()), "birthDate", [], "any", false, false, false, 30), 'label', ["label_attr" => ["class" => "block text-gray-100 mb-2 font-medium tracking-wide"], "label" => "Date de Naissance"]);
        yield "
                                ";
        // line 31
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 31, $this->source); })()), "birthDate", [], "any", false, false, false, 31), 'widget', ["attr" => ["class" => "form-input bg-gray-700 text-gray-200 border border-gray-600 rounded-lg w-full p-4 shadow-sm focus:ring-2 focus:ring-indigo-500 transition duration-300"]]);
        yield "
                            </div>
        ...
        <div class=\"relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2\">
            ...
            <div class=\"relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.xl)+1px)] bg-gray-900 shadow-lg\">
                <div class=\"p-6 rounded-xl backdrop-blur-md\">
                    ...
                    ";
        // line 62
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["passwordForm"]) || array_key_exists("passwordForm", $context) ? $context["passwordForm"] : (function () { throw new RuntimeError('Variable "passwordForm" does not exist.', 62, $this->source); })()), 'form_start');
        yield "
                        <div class=\"mb-6\">
                            ";
        // line 64
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["passwordForm"]) || array_key_exists("passwordForm", $context) ? $context["passwordForm"] : (function () { throw new RuntimeError('Variable "passwordForm" does not exist.', 64, $this->source); })()), "current_password", [], "any", false, false, false, 64), 'label', ["label_attr" => ["class" => "block text-gray-100 mb-2 font-medium tracking-wide"], "label" => "Mot de passe actuel"]);
        yield "
                            ";
        // line 65
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["passwordForm"]) || array_key_exists("passwordForm", $context) ? $context["passwordForm"] : (function () { throw new RuntimeError('Variable "passwordForm" does not exist.', 65, $this->source); })()), "current_password", [], "any", false, false, false, 65), 'widget', ["attr" => ["class" => "form-input bg-gray-700 text-gray-200 border border-gray-600 rounded-lg w-full p-4 shadow-sm focus:ring-2 focus:ring-purple-500 transition duration-300"]]);
        yield "
                        </div>
                        ...
                        <div class=\"mb-6\">
                            ";
        // line 69
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["passwordForm"]) || array_key_exists("passwordForm", $context) ? $context["passwordForm"] : (function () { throw new RuntimeError('Variable "passwordForm" does not exist.', 69, $this->source); })()), "new_password", [], "any", false, false, false, 69), 'label', ["label_attr" => ["class" => "block text-gray-100 mb-2 font-medium tracking-wide"], "label" => "Nouveau mot de passe"]);
        yield "
                            ";
        // line 70
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["passwordForm"]) || array_key_exists("passwordForm", $context) ? $context["passwordForm"] : (function () { throw new RuntimeError('Variable "passwordForm" does not exist.', 70, $this->source); })()), "new_password", [], "any", false, false, false, 70), 'widget', ["attr" => ["class" => "form-input bg-gray-700 text-gray-200 border border-gray-600 rounded-lg w-full p-4 shadow-sm focus:ring-2 focus:ring-purple-500 transition duration-300"]]);
        yield "
                        </div>
                        ...
                        <div class=\"mb-6\">
                            ";
        // line 74
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["passwordForm"]) || array_key_exists("passwordForm", $context) ? $context["passwordForm"] : (function () { throw new RuntimeError('Variable "passwordForm" does not exist.', 74, $this->source); })()), "confirm_password", [], "any", false, false, false, 74), 'label', ["label_attr" => ["class" => "block text-gray-100 mb-2 font-medium tracking-wide"], "label" => "Confirmer le nouveau mot de passe"]);
        yield "
                            ";
        // line 75
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["passwordForm"]) || array_key_exists("passwordForm", $context) ? $context["passwordForm"] : (function () { throw new RuntimeError('Variable "passwordForm" does not exist.', 75, $this->source); })()), "confirm_password", [], "any", false, false, false, 75), 'widget', ["attr" => ["class" => "form-input bg-gray-700 text-gray-200 border border-gray-600 rounded-lg w-full p-4 shadow-sm focus:ring-2 focus:ring-purple-500 transition duration-300"]]);
        yield "
                        </div>
                    ...
                    ";
        // line 83
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["passwordForm"]) || array_key_exists("passwordForm", $context) ? $context["passwordForm"] : (function () { throw new RuntimeError('Variable "passwordForm" does not exist.', 83, $this->source); })()), 'form_end');
        yield "
                </div>
            </div>
...
";
    ...
    {
        return array (  230 => 83,  219 => 75,  215 => 74,  208 => 70,  204 => 69,  197 => 65,  193 => 64,  188 => 62,  162 => 39,  151 => 31,  147 => 30,  140 => 26,  136 => 25,  129 => 21,  125 => 20,  118 => 16,  114 => 15,  109 => 13,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
                    ...
                    <h2 class=\"text-2xl font-bold text-gray-100 mb-6\">Informations Personnelles</h2>
                        {{ form_start(form) }}
                            ...
                            <div class=\"mb-6\">
                                ...
                                {{ form_widget(form.email, {'attr': {'class': 'form-input bg-gray-700 text-gray-200 border border-gray-600 rounded-lg w-full p-4 shadow-sm focus:ring-2 focus:ring-indigo-500 transition duration-300'}}) }}
                            </div>

                            <div class=\"mb-6\">
                                {{ form_label(form.birthDate, 'Date de Naissance', {'label_attr': {'class': 'block text-gray-100 mb-2 font-medium tracking-wide'}}) }}
                                {{ form_widget(form.birthDate, {'attr': {'class': 'form-input bg-gray-700 text-gray-200 border border-gray-600 rounded-lg w-full p-4 shadow-sm focus:ring-2 focus:ring-indigo-500 transition duration-300'}}) }}
                            </div>
