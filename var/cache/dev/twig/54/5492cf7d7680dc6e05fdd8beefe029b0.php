    ...
    <div class=\"p-4 sm:p-6\">
        ...
        if ( !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["groupe_j_d_r"]) || array_key_exists("groupe_j_d_r", $context) ? $context["groupe_j_d_r"] : (function () { throw new RuntimeError('Variable "groupe_j_d_r" does not exist.', 129, $this->source); })()), "id", [], "any", false, false, false, 129))) {
            ...
            yield "                    </div>
                ...
                ";
            // line 168
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["groupe_j_d_r"]) || array_key_exists("groupe_j_d_r", $context) ? $context["groupe_j_d_r"] : (function () { throw new RuntimeError('Variable "groupe_j_d_r" does not exist.', 168, $this->source); })()), "players", [], "any", false, false, false, 168)) < CoreExtension::getAttribute($this->env, $this->source, (isset($context["groupe_j_d_r"]) || array_key_exists("groupe_j_d_r", $context) ? $context["groupe_j_d_r"] : (function () { throw new RuntimeError('Variable "groupe_j_d_r" does not exist.', 168, $this->source); })()), "maxPlayer", [], "any", false, false, false, 168))) {
                // line 169
                ...
                // line 172
                $context['_parent'] = $context;
                $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["groupe_j_d_r"]) || array_key_exists("groupe_j_d_r", $context) ? $context["groupe_j_d_r"] : (function () { throw new RuntimeError('Variable "groupe_j_d_r" does not exist.', 172, $this->source); })()), "invitations", [], "any", false, false, false, 172));
                foreach ($context['_seq'] as $context["_key"] => $context["invitation"]) {
                    // line 173
                    yield "                                ";
                    if (((CoreExtension::getAttribute($this->env, $this->source, $context["invitation"], "status", [], "any", false, false, false, 173) == "pending") && (CoreExtension::getAttribute($this->env, $this->source, $context["invitation"], "user", [], "any", false, false, false, 173) != CoreExtension::getAttribute($this->env, $this->source, (isset($context["groupe_j_d_r"]) || array_key_exists("groupe_j_d_r", $context) ? $context["groupe_j_d_r"] : (function () { throw new RuntimeError('Variable "groupe_j_d_r" does not exist.', 173, $this->source); })()), "owner", [], "any", false, false, false, 173)))) {
                        // line 174
                        yield "                                    <div class=\"relative bg-yellow-200 p-4 rounded-lg shadow flex flex-col items-center space-y-4 text-center\">
                                        ";
                        // line 175
                        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["invitation"], "user", [], "any", false, false, false, 175), "avatar", [], "any", false, false, false, 175)) {
                            // line 176
                            yield "                                            <img class=\"w-16 h-16 rounded-full object-cover\" alt=\"";
                            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["invitation"], "user", [], "any", false, false, false, 176), "username", [], "any", false, false, false, 176), "html", null, true);
                            yield "\" src=\"";
                            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("uploads/avatars/" . CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["invitation"], "user", [], "any", false, false, false, 176), "avatar", [], "any", false, false, false, 176))), "html", null, true);
                            yield "\">
                                        ";
                        } else {
                            // line 178
                        ...
                        // line 181
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["invitation"], "user", [], "any", false, false, false, 181), "username", [], "any", false, false, false, 181), "html", null, true);
                        yield "</p>
                        ...
                        // line 184
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["invitation"], "id", [], "any", false, false, false, 184), "html", null, true);
                        yield "\">
                                            <svg xmlns=\"http://www.w3.org/2000/svg\" class=\"h-4 w-4\" fill=\"none\" viewBox=\"0 0 24 24\" stroke=\"currentColor\">
                                                <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M6 18L18 6M6 6l12 12\" />
                                            </svg>
            ...
            yield "
                ";
            // line 196
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["groupe_j_d_r"]) || array_key_exists("groupe_j_d_r", $context) ? $context["groupe_j_d_r"] : (function () { throw new RuntimeError('Variable "groupe_j_d_r" does not exist.', 196, $this->source); })()), "players", [], "any", false, false, false, 196)) < CoreExtension::getAttribute($this->env, $this->source, (isset($context["groupe_j_d_r"]) || array_key_exists("groupe_j_d_r", $context) ? $context["groupe_j_d_r"] : (function () { throw new RuntimeError('Variable "groupe_j_d_r" does not exist.', 196, $this->source); })()), "maxPlayer", [], "any", false, false, false, 196))) {
                // line 197
                yield "                    <div class=\"mb-4\">
        ...
        <div class=\"flex justify-end mt-6\">
            <button type=\"submit\" class=\"bg-blue-500 text-white px-6 py-3 rounded-md shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500\">
                ";
        // line 214
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 214, $this->source); })()), "Save")) : ("Save")), "html", null, true);
        yield "
            </button>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const maxPlayerInput = document.getElementById('";
        // line 238
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 238, $this->source); })()), "maxPlayer", [], "any", false, false, false, 238), "vars", [], "any", false, false, false, 238), "id", [], "any", false, false, false, 238), "html", null, true);
        yield "');
    ...
    function updateStatusExplanation() {
        ...
        // line 258
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 258, $this->source); })()), "status", [], "any", false, false, false, 258), "vars", [], "any", false, false, false, 258), "id", [], "any", false, false, false, 258), "html", null, true);
        yield "');
    ...
    document.getElementById('";
        // line 264
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 264, $this->source); })()), "status", [], "any", false, false, false, 264), "vars", [], "any", false, false, false, 264), "id", [], "any", false, false, false, 264), "html", null, true);
    ...
    ";
        // line 341
        if ((array_key_exists("groupe_j_d_r", $context) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, (isset($context["groupe_j_d_r"]) || array_key_exists("groupe_j_d_r", $context) ? $context["groupe_j_d_r"] : (function () { throw new RuntimeError('Variable "groupe_j_d_r" does not exist.', 341, $this->source); })()), "id", [], "any", false, false, false, 341)))) {
            // line 342
            yield "        jdrId = ";
            yield CoreExtension::getAttribute($this->env, $this->source, (isset($context["groupe_j_d_r"]) || array_key_exists("groupe_j_d_r", $context) ? $context["groupe_j_d_r"] : (function () { throw new RuntimeError('Variable "groupe_j_d_r" does not exist.', 342, $this->source); })()), "id", [], "any", false, false, false, 342);
            yield ";
    ";
        }
        // line 344
...
";
    ...
    {
        return array (  659 => 344,  653 => 342,  651 => 341,  571 => 264,  562 => 258,  539 => 238,  516 => 218,  509 => 214,  503 => 210,  494 => 203,  486 => 197,  484 => 196,  481 => 195,  476 => 192,  470 => 191,  460 => 184,  454 => 181,  451 => 180,  443 => 178,  435 => 176,  433 => 175,  430 => 174,  427 => 173,  423 => 172,  418 => 169,  416 => 168,  411 => 165,  401 => 161,  398 => 160,  390 => 158,  382 => 156,  380 => 155,  372 => 150,  367 => 149,  363 => 148,  357 => 144,  354 => 143,  348 => 139,  342 => 135,  339 => 134,  337 => 133,  332 => 130,  330 => 129,  323 => 125,  313 => 118,  309 => 117,  301 => 112,  289 => 102,  271 => 90,  267 => 89,  261 => 86,  257 => 85,  251 => 81,  247 => 80,  243 => 79,  235 => 74,  232 => 73,  213 => 70,  209 => 69,  206 => 68,  203 => 67,  185 => 66,  183 => 65,  170 => 55,  163 => 51,  151 => 41,  149 => 38,  139 => 31,  130 => 25,  125 => 23,  121 => 22,  113 => 17,  109 => 16,  105 => 15,  97 => 9,  91 => 7,  85 => 5,  83 => 4,  75 => 3,  72 => 2,  49 => 1,);
    }
