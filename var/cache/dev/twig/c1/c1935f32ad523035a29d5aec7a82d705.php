    ...
    <div class=\"grid grid-cols-1 md:grid-cols-2 gap-8\">
        ...
        yield "\"
                ...
                <div class=\"ml-6\">
                    ";
        // line 200
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["avatarForm"]) || array_key_exists("avatarForm", $context) ? $context["avatarForm"] : (function () { throw new RuntimeError('Variable "avatarForm" does not exist.', 200, $this->source); })()), "avatar", [], "any", false, false, false, 200), 'widget', ["attr" => ["class" => "hidden", "onchange" => "previewAvatar(this)"]]);
        yield "
                    ";
        // line 201
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["avatarForm"]) || array_key_exists("avatarForm", $context) ? $context["avatarForm"] : (function () { throw new RuntimeError('Variable "avatarForm" does not exist.', 201, $this->source); })()), "avatar", [], "any", false, false, false, 201), 'errors');
        yield "
                    <label for=\"";
        // line 202
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["avatarForm"]) || array_key_exists("avatarForm", $context) ? $context["avatarForm"] : (function () { throw new RuntimeError('Variable "avatarForm" does not exist.', 202, $this->source); })()), "avatar", [], "any", false, false, false, 202), "vars", [], "any", false, false, false, 202), "id", [], "any", false, false, false, 202), "html", null, true);
        yield "\" class=\"cursor-pointer bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700 inline-flex items-center transition-transform duration-300 transform hover:-translate-y-1\">
            ...
            ";
        // line 216
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["avatarForm"]) || array_key_exists("avatarForm", $context) ? $context["avatarForm"] : (function () { throw new RuntimeError('Variable "avatarForm" does not exist.', 216, $this->source); })()), 'form_end');
        yield "
        </div>
    </div>
</div>
...
";
    ...
    {
        return array (  552 => 299,  466 => 216,  449 => 202,  445 => 201,  441 => 200,  431 => 193,  424 => 189,  416 => 184,  404 => 175,  400 => 174,  396 => 173,  389 => 169,  385 => 168,  381 => 167,  374 => 163,  370 => 162,  366 => 161,  360 => 158,  352 => 153,  341 => 145,  336 => 143,  326 => 136,  321 => 134,  311 => 127,  307 => 126,  303 => 125,  296 => 121,  292 => 120,  288 => 119,  281 => 115,  277 => 114,  273 => 113,  266 => 109,  262 => 108,  258 => 107,  251 => 103,  243 => 98,  230 => 88,  227 => 87,  225 => 84,  221 => 83,  214 => 79,  210 => 78,  206 => 77,  199 => 73,  195 => 71,  193 => 63,  183 => 56,  176 => 52,  172 => 50,  170 => 45,  159 => 37,  152 => 33,  148 => 32,  144 => 31,  137 => 27,  133 => 26,  129 => 25,  122 => 21,  119 => 20,  117 => 15,  113 => 14,  106 => 10,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
