...
/* vip/vip.html.twig */
class __TwigTemplate_5da86e3b76464196e866fa7af6725d3e extends Template
{
            ...
            fetch(`/api/search-user?username=\${encodeURIComponent(username)}`)
                ...
                .then(data => {
                    if (data.error) {
                        ...
                        userInfo.innerText = `\${data.username} (\${data.email})`;
...
{% endblock %}
", "vip/vip.html.twig", "/home/benjamin/Dicefinder/templates/vip/vip.html.twig");
    }
}
